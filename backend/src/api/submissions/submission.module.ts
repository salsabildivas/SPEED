...
import { Submitted_Article, SubmittedArticleSchema } from './submitted_article.schema';
@Module({
  imports: [
    MongooseModule.forFeature([{ name: Submitted_Article.name, schema: SubmittedArticleSchema }]),
  ],
